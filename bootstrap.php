	...
	final public static function loadClass(string $class): void {
		if (strpos($class, '_PHPStan_') === 0) {
			if (self::$composerAutoloader === null) {
				...
				require_once __DIR__ . '/phpstan.phar/vendor/react/promise-timer/src/functions_include.php';
				require_once __DIR__ . '/phpstan.phar/vendor/react/promise/src/functions_include.php';
				require_once __DIR__ . '/phpstan.phar/vendor/ringcentral/psr7/src/functions_include.php';
			}
