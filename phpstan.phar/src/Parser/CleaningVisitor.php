...
class CleaningVisitor extends NodeVisitorAbstract
{
    ...
    private function keepVariadicsAndYields(array $stmts) : array
    {
        ...
        foreach ($results as $result) {
            if ($result instanceof Node\Expr\Yield_ || $result instanceof Node\Expr\YieldFrom || $result instanceof Node\Expr\Closure || $result instanceof Node\Expr\ArrowFunction) {
