...
final class ArgumentsNormalizer
{
    ...
    public static function reorderCallUserFuncArguments(FuncCall $callUserFuncCall, \PHPStan\Analyser\Scope $scope) : ?array
    {
        ...
        $parametersAcceptor = ParametersAcceptorSelector::selectFromArgs($scope, $passThruArgs, $calledOnType->getCallableParametersAcceptors($scope));
        return [$parametersAcceptor, new FuncCall($callbackArg->value, $passThruArgs, $callUserFuncCall->getAttributes())];
    }
