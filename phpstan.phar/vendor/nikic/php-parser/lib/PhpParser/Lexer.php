...
class Lexer
{
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('_PHPStan_c6b09fbdf\\T_ONUMBER')) {
            $tokenMap[\_PHPStan_c6b09fbdf\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('_PHPStan_c6b09fbdf\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\_PHPStan_c6b09fbdf\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
