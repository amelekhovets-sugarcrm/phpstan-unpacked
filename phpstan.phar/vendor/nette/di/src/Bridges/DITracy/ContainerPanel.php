...
namespace _PHPStan_c6b09fbdf\Nette\Bridges\DITracy;

use _PHPStan_c6b09fbdf\Nette;
use _PHPStan_c6b09fbdf\Nette\DI\Container;
use _PHPStan_c6b09fbdf\Tracy;
/**
...
class ContainerPanel implements Tracy\IBarPanel
{
    ...
    public function getPanel() : string
    {
        ...
        return Nette\Utils\Helpers::capture(function () use($tags, $services) {
            ...
            $parameters = $rc->getMethod('getStaticParameters')->getDeclaringClass()->getName() === Container::class ? null : $container->getParameters();
