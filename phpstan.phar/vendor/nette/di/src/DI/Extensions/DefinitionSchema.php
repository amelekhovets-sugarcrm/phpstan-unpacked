...
namespace _PHPStan_c6b09fbdf\Nette\DI\Extensions;

use _PHPStan_c6b09fbdf\Nette;
use _PHPStan_c6b09fbdf\Nette\DI\Config\Helpers;
use _PHPStan_c6b09fbdf\Nette\DI\Definitions;
use _PHPStan_c6b09fbdf\Nette\DI\Definitions\Statement;
use _PHPStan_c6b09fbdf\Nette\Schema\Context;
...
class DefinitionSchema implements Schema
{
    ...
    {
        return Expect::structure(['type' => Expect::type('string'), 'create' => Expect::type('callable|_PHPStan_c6b09fbdf\\Nette\\DI\\Definitions\\Statement'), 'arguments' => Expect::array(), 'setup' => Expect::listOf('callable|_PHPStan_c6b09fbdf\\Nette\\DI\\Definitions\\Statement|array:1'), 'inject' => Expect::bool(), 'autowired' => Expect::type('bool|string|array'), 'tags' => Expect::array(), 'reset' => Expect::array(), 'alteration' => Expect::bool()]);
    }
    private static function getAccessorSchema() : Schema
    {
        return Expect::structure(['type' => Expect::string(), 'implement' => Expect::string(), 'create' => Expect::type('callable|_PHPStan_c6b09fbdf\\Nette\\DI\\Definitions\\Statement'), 'autowired' => Expect::type('bool|string|array'), 'tags' => Expect::array()]);
    }
    private static function getFactorySchema() : Schema
    {
        return Expect::structure(['type' => Expect::string(), 'create' => Expect::type('callable|_PHPStan_c6b09fbdf\\Nette\\DI\\Definitions\\Statement'), 'implement' => Expect::string(), 'arguments' => Expect::array(), 'setup' => Expect::listOf('callable|_PHPStan_c6b09fbdf\\Nette\\DI\\Definitions\\Statement|array:1'), 'parameters' => Expect::array(), 'references' => Expect::array(), 'tagged' => Expect::string(), 'inject' => Expect::bool(), 'autowired' => Expect::type('bool|string|array'), 'tags' => Expect::array(), 'reset' => Expect::array()]);
    }
