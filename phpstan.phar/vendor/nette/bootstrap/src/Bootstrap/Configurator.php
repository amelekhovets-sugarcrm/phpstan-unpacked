...
namespace _PHPStan_c6b09fbdf\Nette\Bootstrap;

use _PHPStan_c6b09fbdf\Composer\Autoload\ClassLoader;
use _PHPStan_c6b09fbdf\Latte;
use _PHPStan_c6b09fbdf\Nette;
use _PHPStan_c6b09fbdf\Nette\DI;
