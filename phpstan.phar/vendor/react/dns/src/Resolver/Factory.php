...
namespace _PHPStan_c6b09fbdf\React\Dns\Resolver;

use _PHPStan_c6b09fbdf\React\Cache\ArrayCache;
use _PHPStan_c6b09fbdf\React\Cache\CacheInterface;
use _PHPStan_c6b09fbdf\React\Dns\Config\Config;
use _PHPStan_c6b09fbdf\React\Dns\Config\HostsFile;
use _PHPStan_c6b09fbdf\React\Dns\Query\CachingExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\CoopExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\ExecutorInterface;
use _PHPStan_c6b09fbdf\React\Dns\Query\FallbackExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\HostsFileExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\RetryExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\SelectiveTransportExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\TcpTransportExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\TimeoutExecutor;
use _PHPStan_c6b09fbdf\React\Dns\Query\UdpTransportExecutor;
