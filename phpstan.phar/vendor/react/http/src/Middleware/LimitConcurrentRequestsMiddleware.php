...
namespace _PHPStan_c6b09fbdf\React\Http\Middleware;

use _PHPStan_c6b09fbdf\Psr\Http\Message\ResponseInterface;
use _PHPStan_c6b09fbdf\Psr\Http\Message\ServerRequestInterface;
use _PHPStan_c6b09fbdf\React\Http\Io\HttpBodyStream;
use _PHPStan_c6b09fbdf\React\Http\Io\PauseBufferStream;
