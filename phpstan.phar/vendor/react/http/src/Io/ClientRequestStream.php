...
use _PHPStan_c6b09fbdf\Psr\Http\Message\MessageInterface;
...
use _PHPStan_c6b09fbdf\RingCentral\Psr7 as gPsr;
/**
 * @event response
 * @event drain
 * @event error
