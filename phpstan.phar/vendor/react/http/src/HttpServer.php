...
namespace _PHPStan_c6b09fbdf\React\Http;

use _PHPStan_c6b09fbdf\Evenement\EventEmitter;
use _PHPStan_c6b09fbdf\React\EventLoop\Loop;
use _PHPStan_c6b09fbdf\React\EventLoop\LoopInterface;
use _PHPStan_c6b09fbdf\React\Http\Io\IniUtil;
use _PHPStan_c6b09fbdf\React\Http\Io\MiddlewareRunner;
use _PHPStan_c6b09fbdf\React\Http\Io\StreamingServer;
use _PHPStan_c6b09fbdf\React\Http\Middleware\LimitConcurrentRequestsMiddleware;
use _PHPStan_c6b09fbdf\React\Http\Middleware\StreamingRequestMiddleware;
use _PHPStan_c6b09fbdf\React\Http\Middleware\RequestBodyBufferMiddleware;
use _PHPStan_c6b09fbdf\React\Http\Middleware\RequestBodyParserMiddleware;
use _PHPStan_c6b09fbdf\React\Socket\ServerInterface;
/**
