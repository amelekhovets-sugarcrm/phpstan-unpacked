...
use _PHPStan_c6b09fbdf\React\Dns\Config\Config as DnsConfig;
use _PHPStan_c6b09fbdf\React\Dns\Resolver\Factory as DnsFactory;
...
final class Connector implements ConnectorInterface
{
    ...
    public function connect($uri)
    {
        ...
        if (!isset($this->connectors[$scheme])) {
            return \_PHPStan_c6b09fbdf\React\Promise\reject(new \RuntimeException('No connector available for URI scheme "' . $scheme . '" (EINVAL)', \defined('SOCKET_EINVAL') ? \SOCKET_EINVAL : 22));
        }
