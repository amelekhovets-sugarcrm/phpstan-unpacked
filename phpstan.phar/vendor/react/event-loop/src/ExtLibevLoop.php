...
use _PHPStan_c6b09fbdf\libev\EventLoop;
use _PHPStan_c6b09fbdf\libev\IOEvent;
use _PHPStan_c6b09fbdf\libev\SignalEvent;
use _PHPStan_c6b09fbdf\libev\TimerEvent;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('_PHPStan_c6b09fbdf\\libev\\EventLoop', \false)) {
